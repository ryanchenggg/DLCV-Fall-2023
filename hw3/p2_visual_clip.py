...
def main(args):
    ...
    # print(len(set(predictions.keys())))
    # print('-----------------')
    # print(len(set(gts.keys())))
    ...
    # CLIPScore
    clip_scores = CLIPScore()(predictions, args.images_root)
    
    # print(f"CIDEr: {cider_score} | CLIPScore: {clip_score}")
    # Find the highest and lowest CLIPScore pairs
    highest_score_pair = max(clip_scores, key=clip_scores.get)
    lowest_score_pair = min(clip_scores, key=clip_scores.get)
    highest_score_caption = predictions[highest_score_pair]
    lowest_score_caption = predictions[lowest_score_pair]
    print(f"Highest CLIPScore Caption: {highest_score_caption}")
    print(f"Lowest CLIPScore Caption: {lowest_score_caption}")

    print(f"Highest CLIPScore Pair: {highest_score_pair} - Score: {clip_scores[highest_score_pair]}")
    print(f"Lowest CLIPScore Pair: {lowest_score_pair} - Score: {clip_scores[lowest_score_pair]}")
